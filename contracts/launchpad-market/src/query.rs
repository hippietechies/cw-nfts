use crate::state::BidderBidsResponse;
...
impl<'a> MarketContract<'a>
{
    ...
    pub fn query(&self, deps: Deps, env: Env, msg: QueryMsg) -> StdResult<Binary> {
        match msg {
            ...
            QueryMsg::BidderBidsInfo { bidder, include_expired, start_after, skip, limit } =>
                to_binary(&self.bidder_bids_info(deps, env, bidder, include_expired.unwrap_or(false), start_after, skip, limit)?),
